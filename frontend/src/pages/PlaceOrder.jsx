        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
            <div onClick={() => setMethod('stripe')} className='flex items-center gap-3 border border-gray-400 p-2 px-3 cursor-pointer'>
              ...
              <img src={assets.stripeLogo} alt='Pay through Stripe' />
            </div>
            <div onClick={() => setMethod('cod')} className='flex items-center gap-3 border border-gray-400 p-2 px-3 cursor-pointer'>
              ...
              <p className='text-base text-gray-600 font-medium mx-4'>Cash on Delivery</p>
            </div>
          </div>
        </div>

        <div className='w-full text-end mt-8'>
          <button type="submit" className='cursor-pointer uppercase bg-slate-800 text-white px-16 py-3 text-sm'>Place order</button>
        </div>
      </div>
    </form>
  )
