  ...
  return (
    <div>
      ...
      <div>{orders.map(order => (
        <div className='grid grid-cols-1 sm:grid-cols-[0.5fr_2fr_1fr] lg:grid-cols-[0.5fr_2fr_1fr_1fr_1fr] gap-3 items-start border border-gray-300 p-5 md:p-8 my-3 md:my-4 text-xs sm:text-sm text-gray-700' key={order._id}>
          <CiBoxes className='w-20 h-20' />
          <div>
          ...
          <div>
            ...
            <p><span className='font-bold'>Payment</span> : {order.payment ? 'Done' : 'Pending'} </p>
